...
public class AdminController{
	...
	@RequestMapping(value="/secured/adm/prueba.htm")
	...
	@RequestMapping(value="/secured/adm/insertar.htm", method = RequestMethod.GET, params={"nombre","fecha","direccion","descripcion","imagen"})
    public ModelAndView insertar(
		...
		ModelAndView model=new ModelAndView();
		model.setViewName("foradmins/formulario_evento");
	...
	@RequestMapping(value="/secured/adm/formulario_evento.htm")
	...
	@RequestMapping(value="/secured/adm/mostrar.htm")
	public ModelAndView mostrar() {
		...
		ModelAndView model =new ModelAndView();
		model.setViewName("foradmins/mostrar");
		
		model.addObject("lista",e.todos());
		
		System.out.println("RESCATA LOS EVENTOS");
